...
| `/about.html` | About TENSA Engineering | Standalone public page | Live | Explains TENSA Engineering as the umbrella engineering company and public home for the ecosystem. Provides concise organizational identity without replacing the deeper Story page. | Website information architecture, website state, content style guide, and approved public mission/builder framing. | Linked from current public headers if About is part of primary navigation. Included in sitemap.xml. | Keep concise and professional. Do not turn it into the Story page or a full project explainer. |
| `/contact.html` | Contact TENSA Engineering | Standalone public page | Live | Provides a simple public contact route for appropriate TENSA Engineering questions, site issues, and ecosystem inquiries after email routing was configured and tested. | Website state, content style guide, and confirmed email-routing setup. Project source docs only if factual project claims are expanded. | Linked footer-only across current public pages. Not included in primary header navigation. Included in sitemap.xml. | Keep simple. Do not expand into support portal, sales page, or public issue tracker until there is a clear need. |
...
| `/knowledge-base/ai-operations/index.html` | AI Operations | Knowledge Base foundation article / category entry | Live | Currently explains AI Operations as the discipline of making AI-assisted work repeatable, grounded, reviewable, and continuous, and routes readers to focused AI Operations guides. Future direction is to make this page a true AI Operations category / article index. | AI Operations methodology source material, content style guide, website state, current project pages, and current public ecosystem positioning. | Linked from Knowledge Base index, NeuroCore Architecture restart link, and article-path navigation. Links to the project-context continuity guide and the next foundation article. Header links to `/projects/`, `/knowledge-base/`, `/glossary/`, and `/story/`. | Next focused IA work: convert this route into an AI Operations category / article index and move the current long-form AI Operations content into a dedicated article page, likely `/knowledge-base/ai-operations/what-is-ai-operations.html` or another approved slug. |
| `/knowledge-base/ai-operations/how-to-keep-ai-from-losing-project-context.html` | How to Keep AI From Losing Project Context | Knowledge Base long-form article / reading-standard proof page | Live | Practical prose-first guide to preserving continuity across long AI-assisted projects with version control, source-of-truth documents, repository connectors, operating rules, verification, documentation maintenance, and disciplined closeout. This page is also the current proof page for the reusable Knowledge Base article reading-experience standard. | AI Operations methodology source material, documentation closeout protocol, repository and connector boundary rules, content style guide, glossary strategy, and current public ecosystem pages. | Linked from the AI Operations page in the practical-guide and related-reading sections. Included in `sitemap.xml`. Links back to AI Operations and related Knowledge Base, Story, and NeuroCore destinations. | Keep as the first focused long-form AI Operations guide and article-format proof page. Preserve the distinction between local and remote repository state, explicit authorization, current reality, and future plans. Apply this prose-first format to future long-form Knowledge Base articles where appropriate. |
...
## Current Knowledge Base Foundation Path

Current recommended public foundation path:
...
Additional live focused article:

| Path | Article | Category | Status |
|---|---|---|---|
| `/knowledge-base/ai-operations/how-to-keep-ai-from-losing-project-context.html` | How to Keep AI From Losing Project Context | AI Operations | Live |
