...
| `/knowledge-base/ai-operations/index.html` | AI Operations | Knowledge Base foundation article / category entry | Live | Explains AI Operations as the discipline of making AI-assisted work repeatable, grounded, reviewable, and continuous, and routes readers to focused AI Operations guides. | AI Operations methodology source material, content style guide, website state, current project pages, and current public ecosystem positioning. | Linked from Knowledge Base index, NeuroCore Architecture restart link, and article-path navigation. Links to the project-context continuity guide and the next foundation article. Header links to `/projects/`, `/knowledge-base/`, `/glossary/`, and `/story/`. | Maintain as article 1 of 8 and the AI Operations category entry. Add focused articles deliberately after source requirements and discovery links are defined. |
| `/knowledge-base/ai-operations/how-to-keep-ai-from-losing-project-context.html` | How to Keep AI From Losing Project Context | Knowledge Base long-form article | Live | Practical guide to preserving continuity across long AI-assisted projects with version control, source-of-truth documents, repository connectors, operating rules, verification, documentation maintenance, and disciplined closeout. | AI Operations methodology source material, documentation closeout protocol, repository and connector boundary rules, content style guide, glossary strategy, and current public ecosystem pages. | Linked from the AI Operations page in the practical-guide and related-reading sections. Included in `sitemap.xml`. Links back to AI Operations and related Knowledge Base, Story, and NeuroCore destinations. | Keep as the first focused long-form AI Operations guide. Preserve the distinction between local and remote repository state, explicit authorization, current reality, and future plans. |
...
The homepage, About page, Contact page, Projects, NeuroCore, Argus ACLI, Argus Lab, Knowledge Base, Glossary, Story, the eight foundation Knowledge Base articles, and the first focused AI Operations long-form article now all have public site structure. The next major website step should either organize future public technical artifacts, publish public-friendly build history, or expand the teaching layer with additional focused articles.
